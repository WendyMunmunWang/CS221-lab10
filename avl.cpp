 ...
 * looking at the root node of a subtree that it has at most 1100 nodes, 
...
void findMaxHelper(Node * root, KType & word, VType & count) {
 ...
 if (lcount < rcount && rcount > root->value){
	 word = rword;
	 count = rcount;
 }
